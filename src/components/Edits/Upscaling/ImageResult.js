      ...
      {uploadedImageUrl && imageUrl && imageDimensions ? (
        <>
          <Box
            sx={{
              ...
              height: imageDimensions.height
                ? `${imageDimensions.height / num}px`
                : "auto",
              width: imageDimensions.width
                ? `${imageDimensions.width / num}px`
                : "auto",
              overflow: "hidden",
              position: "relative",
              display: "flex",
            ...
            <ImgComparisonSlider>
              <figure slot="first" className="before">
                <img
                  ...
                  style={{
                    height: `${imageDimensions.height / num}px`,
                    width: `${imageDimensions.width / num}px`,
                  }}
                  alt="Before"
                />
                <figcaption
          ...
          <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
            ...
            <DialogActions
              style={{ marginRight: "19px", marginBottom: "15px" }}
            >
